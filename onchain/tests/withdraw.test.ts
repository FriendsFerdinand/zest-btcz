...
describe("Withdrawals", () => {
  ...
  it("Withdraw with no rewards", () => {
    ...
    callResponse = simnet.callPublicFn(
      ...
      [
        ...
        Cl.uint(pegInAmount * EXTRA_DECIMALS),
      ],
      address1
    );
  ...
  it("Withdraw with a single user", () => {
    ...
    callResponse = simnet.callPublicFn(
      ...
      [
        ...
        Cl.uint(pegInsats * EXTRA_DECIMALS),
      ],
      address1
    );
    expect(
  ...
  it("Withdraw with a 2 users and one receives half", () => {
    ...
    tx = generatePegInTx(BigInt(pegInSats), pegInOutscript, address2);
    callResponse = simnet.callPublicFn(
      stackingLogicContractName,
      "deposit",
      [
  ...
  it("Withdraw, with peg-out-fees", () => {
    ...
    expect(callResponse.result).toBeUint(pegInSats);
